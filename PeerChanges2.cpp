...
void* serverThread(void * arg)
{
	...
	while(1)
	{
		...
		{
			bzero(buffer,sizeof(buffer));	
			fstream ff("/home/viviek/Desktop/OS_Assignment_2/Peer3/list_files.txt");
			string ss,temp="";
			while(getline(ff,ss))
			{
				if(temp=="")
...
void* uploadFile(void * arg)
{
	...
	string d="/home/viviek/Desktop/OS_Assignment_2/Peer3";
	string fn;
    ...
    while (1) {
     ...
     fstream wFile("/home/viviek/Desktop/OS_Assignment_2/Peer3/list_files.txt",ios_base::out | ios_base::app);
     wFile << fn;
     wFile.close();
